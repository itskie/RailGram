...
- **Private Accounts**: Toggle private profile, only followers see posts. 🔒
- **Block System**: Block/unblock users, filters posts/reels/DMs. 🚫
...
- [x] **Phase 13**: Privacy & Safety — Private Account toggle, Block/Unblock users, blocked content filtering.
