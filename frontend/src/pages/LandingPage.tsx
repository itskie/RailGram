        ...
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-2.5">
            <div className="w-7 h-7 rounded-lg bg-orange-500 flex items-center justify-center">
              <Train size={14} className="text-white" strokeWidth={2} />
            </div>
            <span className="font-black text-lg text-white">RailGram</span>
          </div>
          <p className="text-zinc-600 text-sm">
            © 2026 RailGram · India's Railway Social Network · Built with ❤️ for railfans
          </p>
          <div className="flex items-center gap-6">
            <Link to="/login" className="text-zinc-500 hover:text-zinc-300 text-sm transition-colors">Login</Link>
